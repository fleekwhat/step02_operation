...
public class MainClass01 {
	...
	public static void main(String[] args) {
		...
		byte a = 10;
		// a 는 byte type 인데 a 에 저장된 값을 int type b 에 대입하는 건 문제가 없을까?
		int b = a;
		// b 는 int type 인데 b 에 저장된 값을 byte type  에 대입하는 건 문제가 없을까?
		
		/*
		 * b 자체는 int type 이지만 (byte) 연산자로 casting 하면
		 * 대입연산자의 우측에는 byte type 이 있다고 간주되어서 문법이 성립한다. 
		 * 대신 b에 들어 있는 값이 byte 범위 안에 들어 있다는 것이 확실 할 때만 
		 * casting 해야지 오류가 없다.
		 */
		byte c = (byte)b;
		int d = 1000;
